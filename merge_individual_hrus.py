...
src_dir = '/Users/pnorton/Projects/National_Hydrology_Model/regions/%s_byHRU' % region
# dst_dir = '/Volumes/LaCie/20150720a/regions/%s_byHRU' % region

control_file = '%s/daymet.control' % parent_dir
...
for dd in proc_list:
    ...
    sys.stdout.write('\r\tHRU: %06d (orig_index=%d) ' % (parent_hru, index_to_orig - 1))
    sys.stdout.flush()
