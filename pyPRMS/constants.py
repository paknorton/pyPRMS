...
ctl_order = ['start_time', 'end_time', 'executable_desc', 'executable_model', 'model_mode', 'param_file', 'data_file',
             'model_output_file', 'parameter_check_flag', 'print_debug',
             ...
             'cbh_binary_flag', 'cbh_check_flag',
             'gwflow_cbh_flag', 'orad_flag', 'snow_cbh_flag',
             'humidity_day', 'potet_day', 'precip_day', 'precip_grid',
             ...
             'initial_deltat', 'cascade_flag', 'cascadegw_flag', 'dprst_flag', 'dyn_covden_flag',
             'dyn_covtype_flag', 'dyn_dprst_flag', 'dyn_fallfrost_flag', 'dyn_imperv_flag', 'dyn_intcp_flag',
             'dyn_potet_flag', 'dyn_radtrncf_flag', 'dyn_snareathresh_flag', 'dyn_soil_flag', 'dyn_springfrost_flag',
             'dyn_sro2dprst_imperv_flag', 'dyn_sro2dprst_perv_flag', 'dyn_transp_flag', 'frozen_flag',
             'gwr_swale_flag', 'stream_temp_flag', 'subbasin_flag',
             ...
             'sro2dprst_imperv_dynamic', 'sro2dprst_perv_dynamic', 'transp_flag_dynamic',
             'transpbeg_dynamic', 'transpend_dynamic', 'wrain_intcp_dynamic',
