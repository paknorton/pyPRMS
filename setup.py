...
from pyPRMS import __version__
...
setup(
    ...
    url='https://github.com/paknorton/pyPRMS',

    # Author details
    author='Parker Norton',
    author_email='pnorton@usgs.gov',
    ...
    keywords='PRMS streamflow modeling development',
    ...
    package_data={'pyPRMS': ['xml/*.xml', 'py.typed'],
